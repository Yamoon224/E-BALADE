    ...
    <div class="container">
        <div class="footer-top">
                ...
                <div class="col">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="add-flight.html">Add Your Listing</a></li>
                ...
                <div class="col">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="chat.html">Chat Support</a></li>
                ...
                <div class="col">
                    <div class="footer-widget">
                        ...
                        <ul class="footer-menu">
                            ...
                            <li><a href="javascript:void(0);">Activity Finder</a></li>
                            <li><a href="flight-grid.html">Flight Finder</a></li>
                            <li><a href="tour-grid.html">Holiday Rental</a></li>
                            <li><a href="car-grid.html">Car Rental</a></li>
                            <li><a href="tour-details.html">Holiday Packages</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-lg-6 col-xl-4 col-xxl-4">
                        <div class="d-flex align-items-center justify-content-center flex-wrap">
                            ...
                            <a href="javascript:void(0);" class="d-block mb-3 me-2">
                                <img src="{{ asset('images/icons/googleplay.svg') }}" alt="logo">
                            </a>
                            <a href="javascript:void(0);" class="d-block mb-3">
                                <img src="{{ asset('images/icons/appstore.svg') }}" alt="logo">
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="d-sm-flex align-items-center justify-content-center justify-content-xl-end">
                            ...
                            <div class="d-flex align-items-center justify-content-center justify-content-sm-start mb-3">
                                ...
                                <div class="ms-2">
                                    ...
                                    <p class="fw-medium text-dark"><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="fd94939b92bd98859c908d9198d39e9290">[email&#160;protected]</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-img">
                <img src="{{ asset('images/bg/footer.svg') }}" class="img-fluid" alt="img">
            </div>
        </div>
    </div>
    <!-- Footer Bottom -->
                        ...
                        <ul class="card-links">
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-01.svg') }}" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-02.svg') }}" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-03.svg') }}" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-04.svg') }}" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-05.svg') }}" alt="img">
                                </a>
                            </li>
                            <li>
                                <a href="javascript:void(0);">
                                    <img src="{{ asset('images/icons/card-06.svg') }}" alt="img">
                                </a>
                            </li>
                        </ul>
                    </div>
