<x-app-layout>
    ...
    <section class="hero-section">
        <div class="banner-slider banner-sec owl-carousel">
            <div class="slider-img">
                <img src="{{ asset('images/banner/banner-01.jpg') }}" alt="Img">
            </div>
            <div class="slider-img">
                <img src="{{ asset('images/banner/banner-02.jpg') }}" alt="Img">
            </div>
            <div class="slider-img">
                <img src="{{ asset('images/banner/banner-03.jpg') }}" alt="Img">
            </div>
            <div class="slider-img">
                <img src="{{ asset('images/banner/banner-04.jpg') }}" alt="Img">
            </div>
        </div>
        <div class="container">
        ...
        <div class="container">
            ...
            <div class="owl-carousel destination-slider nav-center">
                ...
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('images/destination/destination-01.jpg') }}" alt="img">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('images/destination/destination-02.jpg') }}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('images/destination/destination-03.jpg') }}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('images/destination/destination-04.jpg') }}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                ...
                <!-- Destination Item-->
                <div class="destination-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                    <img src="{{ asset('images/destination/destination-05.jpg') }}" alt="img">
                    <div class="destination-info text-center">
                        <div class="destination-content">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="hotel-details.html">
                                            <img src="{{ asset('images/hotels/hotel-01.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="hotel-details.html">
                                            <img src="{{ asset('images/hotels/hotel-02.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="hotel-details.html">
                                            <img src="{{ asset('images/hotels/hotel-03.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="{{ asset('images/users/user-01.jpg') }}" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="{{ asset('images/users/user-06.jpg') }}" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="hotel-details.html">
                                            <img src="{{ asset('images/hotels/hotel-04.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="hotel-details.html">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="{{ asset('images/users/user-02.jpg') }}" class="rounded-circle" alt="img">
										</span>
                        ...
                        <div class="place-item mb-4">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-md me-2">
											<img src="{{ asset('images/users/user-04.jpg') }}" class="rounded-circle" alt="img">
										</span>
                ...
                <div class="tab-pane fade" id="flight-list">
                    <div class="owl-carousel place-slider nav-center">
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <a href="flight-details.html">
                                    <img src="{{ asset('images/flight/flight-01.jpg') }}" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center mb-2">
                                    <span class="avatar avatar-sm me-2">
										<img src="{{ asset('images/icons/airindia.svg') }}" class="rounded-circle" alt="icon">
									</span>
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="{{ asset('images/users/user-11.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-02.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-06.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-07.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="{{ asset('images/users/user-12.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <a href="flight-details.html">
                                    <img src="{{ asset('images/flight/flight-03.jpg') }}" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <div class="d-flex align-items-center">
                                        <a href="javascript:void(0);" class="fav-icon me-2">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="{{ asset('images/users/user-13.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-04.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-08.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="flight-details.html">
                                            <img src="{{ asset('images/flight/flight-10.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="{{ asset('images/users/user-15.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="place-content">
                                ...
                                <div class="d-flex align-items-center justify-content-between border-top pt-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <a href="javascript:void(0);" class="avatar avatar-sm">
                                            <img src="{{ asset('images/users/user-10.jpg') }}" class="rounded-circle" alt="img">
                                        </a>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="place-item mb-4 flex-fill">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-06.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-07.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-08.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                                    <img src="{{ asset('images/users/user-08.jpg') }}" class="rounded-circle" alt="img">
                                </a>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-09.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                            ...
                            <div class="place-content">
                                <a href="javascript:void(0);" class="avatar avatar-md ms-3 car-avatar-image">
                                    <img src="{{ asset('images/users/user-09.jpg') }}" class="rounded-circle" alt="img">
                                </a>
                                <div class="d-flex align-items-center justify-content-between mb-1">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <span class="badge badge-secondary  fs-10 fw-medium me-1">Sedan</span>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-10.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-11.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-12.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="car-details.html">
                                            <img src="{{ asset('images/cars/car-13.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                ...
                <div class="tab-pane fade" id="Cruise-list">
                    <div class="owl-carousel place-slider nav-center">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                            <img src="{{ asset('images/cruise/cruise-05.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                            <img src="{{ asset('images/cruise/cruise-02.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                            <img src="{{ asset('images/cruise/cruise-04.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="cruise-details.html">
                                    <img src="{{ asset('images/cruise/cruise-12.jpg') }}" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="cruise-details.html">
                                    <img src="{{ asset('images/cruise/cruise-09.jpg') }}" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <a href="cruise-details.html">
                                    <img src="{{ asset('images/cruise/cruise-10.jpg') }}" class="img-fluid" alt="img">
                                </a>
                                <div class="fav-item">
                                    <a href="javascript:void(0);" class="fav-icon">
                                        <i class="isax isax-heart5"></i>
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                            <img src="{{ asset('images/cruise/cruise-01.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                            <img src="{{ asset('images/cruise/cruise-07.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="cruise-details.html">
                                ...
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-07.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-08.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-09.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-10.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-11.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-12.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
                        ...
                        <div class="place-item mb-4 flex-fill">
                            <div class="place-img">
                                <div class="img-slider image-slide owl-carousel nav-center">
                                    ...
                                    <div class="slide-images">
                                        <a href="tour-details.html">
                                            <img src="{{ asset('images/tours/tours-13.jpg') }}" class="img-fluid" alt="img">
                                        </a>
                                    </div>
                                </div>
                                <div class="fav-item">
    ...
    <section class="section about-section">
        <div class="container">
                    ...
                    <div class="about-image mb-4 mb-lg-0">
                        <div class="about-listing">
                            ...
                            <div class="listing-img">
                                <div>
                                    <img src="{{ asset('images/icons/listing.svg') }}" alt="icon">
                                </div>
                        ...
                        <div class="about-progress d-inline-flex align-items-center">
                            <img src="{{ asset('images/icons/progress-icon.svg') }}" alt="icon">
                            <div class="ms-2">
                    ...
                    <div class="d-flex align-items-center flex-wrap about-btn gap-2">
                        ...
                        <div class="avatar-list-stacked avatar-group-md me-2">
                            <span class="avatar avatar-rounded">
								<img class="border border-white" src="{{ asset('images/users/user-01.jpg') }}" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img class="border border-white" src="{{ asset('images/users/user-04.jpg') }}" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img src="{{ asset('images/users/user-05.jpg') }}" alt="img">
							</span>
                            <span class="avatar avatar-rounded">
								<img src="{{ asset('images/users/user-06.jpg') }}" alt="img">
							</span>
                        </div>
                        <div>
                            <div class="d-flex align-items-center">
            ...
            <div class="about-bg">
                <img src="{{ asset('images/bg/about-bg.png') }}" alt="img" class="about-bg-01">
                <img src="{{ asset('images/bg/about-bg-01.svg') }}" alt="img" class="about-bg-02">
            </div>
        </div>
    </section>
    <!-- /About Section -->
        ...
        <div class="container">
            ...
            <div class="owl-carousel experts-slider nav-center">
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-purple-100 position-relative">
                            <img src="{{ asset('images/expert/expert-01.png') }}" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{ asset('images/flags/brazil.svg') }}" alt="img" class="me-2">Brazil, Rio</p>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-orange-100 position-relative">
                            <img src="{{ asset('images/expert/expert-02.png') }}" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{ asset('images/flags/japan.svg') }}" alt="img" class="me-2">Tokyo, Japan</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>21</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-pink-100 position-relative">
                            <img src="{{ asset('images/expert/expert-03.png') }}" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{ asset('images/flags/africa.svg') }}" alt="img" class="me-2">Cape Town, South Africa</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>15</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-teal-100 position-relative">
                            <img src="{{ asset('images/expert/expert-04.png') }}" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <h5 class="mb-1"><a href="javascript:void(0);">Damien Martien</a></h5>
                        <p class="d-flex align-items-center"><img src="{{ asset('images/flags/australia.svg') }}" alt="img" class="me-2">Sydney, Australia</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>15</h6>
                ...
                <div class="expert-item mb-4">
                    <a href="javascript:void(0);" class="expert-img">
                        <div class="bg-purple-100 position-relative">
                            <img src="{{ asset('images/expert/expert-05.png') }}" alt="img">
                    ...
                    <div class="expert-content">
                        ...
                        <p class="d-flex align-items-center"><img src="{{ asset('images/flags/norway.svg') }}" alt="img" class="me-2">Oslo, Norway</p>
                        <div class="d-flex border-top mt-3 pt-3">
                            <div class="flex-fill">
                                <p class="mb-1">Total Listings</p>
                                <h6>17</h6>
        ...
        <div class="container">
            ...
            <div class="owl-carousel client-slider">
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-01.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-02.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-03.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-04.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-05.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-06.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-07.svg') }}" alt="img">
                </div>
                <div class="client-img">
                    <img src="{{ asset('images/clients/client-04.svg') }}" alt="img">
                </div>
    ...
    <section class="section testimonial-section">
                ...
                <div class="card border-white wow fadeInUp" data-wow-delay="0.2s">
                    <div class="card-body">
                        ...
                        <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <a href="javascript:void(0);" class="avatar avatar-md  flex-shrink-0">
                                    <img src="{{ asset('images/users/user-03.jpg') }}" class="rounded-circle" alt="img">
                                </a>
                                <div class="ms-2">
                        ...
                        <div class="border-top pt-4 d-flex align-items-center justify-content-between">
                            <div class="d-flex align-items-center">
                                <span class="avatar avatar-md  flex-shrink-0">
                                    <img src="{{ asset('images/users/user-05.jpg') }}" class="rounded-circle" alt="img">
                                </span>
                                <div class="ms-2">
        ...
        <div class="testimonial-bg">
            <img src="{{ asset('images/bg/testimonial-bg-01.svg') }}" alt="img">
        </div>
    </section>
    <!-- /Testimonial Section -->
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="update-sec">
                        ...
                        <div class="update-bg">
                            <img src="{{ asset('images/bg/update-bg.png') }}" alt="img">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="blog-details.html" class="blog-img">
                            <img src="{{ asset('images/blog/blog-01.jpg') }}" alt="img">
                        </a>
                                ...
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="{{ asset('images/users/user-01.jpg') }}" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Bryan Bradfield</p>
                                    </a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="blog-details.html" class="blog-img">
                            <img src="{{ asset('images/blog/blog-02.jpg') }}" alt="img">
                        </a>
                        ...
                        <div class="blog-info text-center">
                            <div class="d-inline-flex align-items-center justify-content-center">
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="{{ asset('images/users/user-02.jpg') }}" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Michell West</p>
                                    </a>
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-item mb-4 wow fadeInUp" data-wow-delay="0.2s">
                        <a href="blog-details.html" class="blog-img">
                            <img src="{{ asset('images/blog/blog-03.jpg') }}" alt="img">
                        </a>
                        ...
                        <div class="blog-info text-center">
                            <div class="d-inline-flex align-items-center justify-content-center">
                                <div class="d-inline-flex align-items-center border-end pe-3 me-3 mb-2">
                                    <a href="javascript:void(0);" class="d-flex align-items-center">
                                        <span class="avatar avatar-sm flex-shrink-0 me-2">
											<img src="{{ asset('images/users/user-03.jpg') }}" class="rounded-circle border border-white" alt="img">
										</span>
                                        <p>Patricia Hasbro</p>
                                    </a>
                                </div>
